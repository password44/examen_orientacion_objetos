...
namespace Ejercicio3
{
    ...
    public class Rectable : Shape
    {
        ...
        {
            action.Invoke(String.Format("e tipo de forma es {0} y el color es {1}", GetType().Name, this.Color));            
        }
    }
    ...
    public class Circle : Shape
    {
        ...
        public override void Draw(Action<String> action)
        {
            action.Invoke(String.Format("el tipo de forma es {0} y el  su color es {1}", GetType().Name, this.Color));
        }
    }
